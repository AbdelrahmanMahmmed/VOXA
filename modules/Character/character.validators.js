...
exports.CreateCharacterValidator = [
  ...
  body("promot")
    .notEmpty()
    .withMessage("promot is required")
    .isString()
    .withMessage("promot must be a string")
    .isLength({ min: 50, max: 1500 })
    .withMessage("promot must be between 50 and 1500 characters"),

  body("personality")
    .isArray({ min: 1 })
    .withMessage("personality must be a non-empty array"),
  ...
  body("Specialist").notEmpty().withMessage("Specialist must be exist"),
...
exports.UpdatedCharacterValidator = [
  ...
  body("promot").optional(),

  body("personality").optional(),
