...
const { CreateMessage, DeleteMessage, GetAllMessages } = require('./message.service');
...
exports.Create = async (req, res, next) => {
    ...
    try {
        const result = await CreateMessage(Character.ChatId, CharacterId, req.body.content);
        res.json({
